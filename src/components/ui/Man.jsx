...
const Man = () => {
  ...
  return (
    <div className="lg:w-[1300px] lg:mt-1 mt-25 w-full mx-auto reveal">

      <div className="bg-gray-900 lg:m-5 m-1.5 rounded-3xl lg:w-305 w-105 h-auto p-5 lg:p-10 flex lg:flex-row  lg:justify-between items-center text-white ">

        {/* content div */}
        <div className="flex flex-col  lg:w-200  ">
          <div className="  ">
            <h1 className="text-3xl  font-semibold">Reimagine your career in the AI era</h1>
            <p className=" font-extralight lg:mt-3 mt-10 w-90 ">Future-proof your skills with Personal Plan. Get access to a variety of fresh content from real-world experts.</p>
          </div>

          <small>
            <div className="grid lg:grid-cols-2 grid-cols-1 font-light  mt-3">
              <div className="mt-5 lg:flex "><WiStars className="bg-purple-300 lg:text-black text:white rounded-full justify-center font-light mr-2" size={21} /> Learn AI and more</div>
        ...
        {/* image div */}
        <div className="lg:p-5 p-2 lg:w-250 w-50">
