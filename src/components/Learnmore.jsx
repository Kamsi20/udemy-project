...
const Learnmore = () => {
  return (
    <div className=' lg:w-[1300px] mx-auto  mt-20'>
      ...
      <div className='flex lg:flex-row flex-col lg:gap-40 gap-15 lg:p-20 px-30 text-5xl font-bold'>
        <div>
          <p>26,000+</p>
      ...
      <div className='flex lg:flex-row flex-col-reverse lg:mt-20 lg:gap-20'>
        <div>
          <img src='11.png' className='lg:w-250 w-100' />
        </div>
        <div className='lg:w-200 mt-40 lg:pr-40 p-10' >
          <p>Current</p>
      ...
      <div className='flex lg:flex-row flex-col lg:mt-20 lg:gap-20 p-10'>
        <div className='lg:w-200 my-20 lg:p-20' >
          <p>Flexible</p>
        ...
        <div>
          <img src='12.png' className='lg:w-250 w-100' />
        </div>
      </div>

      <div className='flex lg:flex-row flex-col-reverse lg:mt-20 lg:gap-20 p-10'>
        <div>
          <img src='13.png' className='lg:w-250 w-100' />
        </div>
        <div className='lg:w-200 mt-40 lg:pr-40' >
          <p>Effective</p>
      ...
      <div className='py-20 p-5'>
        ...
        <div className='flex  pb-5'>
          <div >
            <img src='14.png' alt='img' className='h-160 w-180 hidden md:block' />
          </div>
          <div className='grid lg:grid-cols-2 ' >
            <div className='w-full lg:border-0 border-1 mb-5  rounded-3xl h-55   p-10 '>
            ...
            <div className='w-full  h-55 p-10 lg:border-0 border-1  rounded-3xl'>
            ...
            <div className='w-full lg:border-0 border-1 my-5 rounded-3xl  h-55 p-10 '>
            ...
            <div className='w-full  h-55 lg:border-0 border-1  rounded-3xl p-10 '>
            ...
            <div className='w-full  h-55 lg:border-0 border-1  rounded-3xl my-5  p-10 '>
            ...
            <div className='w-full  h-60 lg:border-0 border-1  rounded-3xl p-10 '>
            ...
            <hr className='lg:mt-15  border-gray-300' />
      ...
      <div className='bg-gray-200  h-300'>
        <p className='lg:px-100 py-10 lg:p-0 p-5 text-3xl font-semibold '>Choose a plan that works for you</p>
        <div className='flex lg:flex-row flex-col gap-10'>

          <div className='w-85 h-120 border-2 bg-white rounded-lg border-purple-800 lg:ml-60  lg:mb-20 mx-10'>
          ...
          <div className='h-110 w-85 bg-white mt-9 rounded-lg mx-10 mb-10'>
