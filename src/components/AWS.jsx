...
const AWS = () => {
  return (
    <div  className='lg:w-[1300px] mx-auto my-20'>
      <div className='bg-gray-100 lg:p-10 p-8'>
        ...
        <h1 className='lg:text-4xl text-3xl font-bold pt-8'>Amazon Web Services (AWS) Certifications Courses</h1>
      ...
      <div className='py-5 px-10'>
       ...
       <Link to={'/awssolutions'}> <ComptiaCard  text='AWS Certified Cloud Practitioner ' texta='2,798,900 learners' bg={assw}/></Link>
      <Link to={'/awssolutions'}>  <ComptiaCard  text='AWS Certified Developer' texta='1,538,000 learners' bg={awss}/></Link>
       <Link to={'/awssolutions'}> <ComptiaCard  text='AWS Certified Solution Architect' texta='597,000 learners' bg={assw}/></Link>
        </div>
      </div>
  ...
  return(
    <div className=' lg:w-[1300px] mx-auto m-5 pt-25' >
      <div className='flex  lg:flex-row flex-col gap-10 ml-7'>
        <img src="/public/18.png" alt="" className='lg:h-50 lg:w-50 w-30' />
        <div className='px-3'>
      ...
      <div className=' flex  lg:flex-row flex-col  border-1 border-gray-400 p-8 rounded-md mt-8'>
        <div className='mb-20'>
          <h2 className='text-xl font-semibold lg:w-100'>Looking to earn a AWS Certified Solutions Architect - Associate certification? We’ve got you covered.</h2> <br />
          <p className='font-semilight text-lg lg:pr-10'>Get everything you need to reach your goals in one convenient bundle.</p><br />
