...
const ai = new GoogleGenAI({apiKey: "AIzaSyAQZR99N2_6J78Q2fXrkDoNispXdpCorbc" })
...
const Chatbot = () => {
  ...
  return (
    ...
    <div className=' flex gap-5 mt-20 bg-gray-900 text-white mb-5'>
      ...
      <div>
        <div className=' flex-col w-[930px] h-100 overflow-auto p-5'>
        ...
        <div className='mt-10 ml-20'>
          <form onSubmit={handleSubmit} className='flex gap-3'>
            <input onChange={handleChange} className='w-120 h-10 border-1 rounded-2xl p-3' placeholder="Ask Anything"/>
